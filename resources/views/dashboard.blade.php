		...
		<div class="col-xl-4">
			...
			<div class="card card-custom bg-gray-100 gutter-b card-stretch">
				...
				<div class="card-header border-0 bg-primary py-5">
					<h3 class="card-title font-weight-bolder text-white">Welcome {{ session('user.name') }}</h3>
				</div>
				<!--end::Header-->
				<!--begin::Body-->
				<div class="card-body p-0 position-relative overflow-hidden">
					<!--begin::Stats-->
					<div class="card-spacer mt-25">
						<!--begin::Row-->
						<div class="row m-0">
							<div class="col bg-white px-6 py-8 rounded-xl mr-7 mb-7">
								...
								<a href="#" class="text-info font-weight-bold font-size-h6">Packages</a>
							</div>
							<div class="col bg-white px-6 py-8 rounded-xl mb-7">
								...
								<a href="#" class="text-warning font-weight-bold font-size-h6 mt-2">Edit Profile</a>
							</div>
						</div>
						<!--end::Row-->
						<!--begin::Row-->
						<div class="row m-0">
							<div class="col bg-white px-6 py-8 rounded-xl mr-7">
								...
								<a href="#" class="text-danger font-weight-bold font-size-h6 mt-2">Subscriptions</a>
							</div>
							<div class="col bg-white px-6 py-8 rounded-xl">
								...
								<a href="#" class="text-success font-weight-bold font-size-h6 mt-2">My Packages</a>
							</div>
						</div>
						<!--end::Row-->
					</div>
		...
		<div class="col-xl-4">
			...
			<div class="card card-custom gutter-b card-stretch">
				...
				<div class="card-header border-0">
					<h3 class="card-title font-weight-bolder text-dark">Trending Jobs</h3>
					<div class="card-toolbar">
						<div class="dropdown dropdown-inline">
